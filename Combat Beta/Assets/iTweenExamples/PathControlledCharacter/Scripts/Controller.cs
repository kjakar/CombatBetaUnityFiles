...
public class Controller : MonoBehaviour {
	...
	void Update(){
		...
		MoveCharacter();
        //MoveCamera();
        Debug.Log(Input.GetAxis("ControllerXaxis") + "   " + Input.GetAxis("ControllerYaxis"));
	}
	...
	void DetectKeys(){
        ...
        //jump:
        if ((Input.GetKeyDown("space") && jumpState==0) || (Input.GetKeyDown("joystick button 0") && jumpState == 0)) {
			ySpeed-=jumpForce;
			jumpState=1;
		}
	}
